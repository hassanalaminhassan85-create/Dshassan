  ...
  return (
    <div className="max-w-6xl mx-auto px-4 md:px-6 py-8 space-y-12 animate-fade-in text-left text-slate-800 dark:text-slate-100">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        ...
        {/* Tab Switcher */}
        <div className="bg-slate-100 dark:bg-slate-900 p-1 rounded-2xl border border-slate-200/50 dark:border-slate-800 flex shadow-sm">
          <button
      ...
      {activeTab === 'student' ? (
        ...
        enrolledCourse ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-4 bg-slate-50 dark:bg-slate-900 border border-slate-200/40 dark:border-slate-800 p-5 rounded-3xl space-y-4 text-left">
              <div>
                <button 
              ...
              {quizStarted ? (
                        ...
                        <>
                          ...
                          <div className="pt-4 flex justify-center gap-3">
                            ...
                            <button
                              ...
                              className="px-5 py-2.5 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 text-xs font-extrabold uppercase rounded-xl"
                            >
                              Back to Lesson
                            </button>
                          </div>
                    ...
                    <div className="space-y-4">
                          ...
                          <button
                            ...
                            className={`w-full p-4 rounded-2xl border text-xs text-left transition-all font-semibold ${
                              selectedAnswers[currentQuestion] === oIdx
                                ...
                                : 'bg-slate-50 dark:bg-slate-950 border-slate-200/50 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-800'
                            }`}
                          >
                            {opt}
                          </button>
                      ...
                      <div className="pt-4 flex justify-between">
                        <input 
                          ...
                          className="px-3 py-2 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl text-xs w-48 text-slate-800 dark:text-slate-100"
                        />
                        <button
                ...
                <div className="space-y-6">
                  <div className="flex justify-between items-center pb-4 border-b border-slate-100 dark:border-slate-800">
                    ...
                    <span className="text-[10px] bg-slate-100 dark:bg-slate-800 text-slate-400 px-2.5 py-1 rounded-full font-bold">LECTURE RUNNING</span>
                  </div>
                  ...
                  <div className="space-y-3 text-left">
                    ...
                    <p className="text-slate-600 dark:text-slate-300 text-xs leading-relaxed font-light bg-slate-50 dark:bg-slate-950 p-4 rounded-2xl border border-slate-100 dark:border-slate-800/60">
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-4 pt-4 border-t border-slate-100 dark:border-slate-800">
                    <button 
                      ...
                      className="px-4 py-2 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 text-[11px] font-extrabold uppercase rounded-xl flex items-center gap-1.5 transition-colors"
                    >
                      <Download size={13} />
                      Download Worksheets
                    </button>
              ...
              <table className="w-full text-left text-xs border-collapse">
                ...
                <tbody className="divide-y divide-slate-100 dark:divide-slate-800 font-semibold text-slate-700 dark:text-slate-300">
                  {certifiedStudents.map((cert) => (
                    <tr key={cert.id} className="hover:bg-slate-50/40 dark:hover:bg-slate-900/30">
                      ...
                      <td className="py-3 text-right">
                        <button
                          ...
                          className="px-2.5 py-1 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-750 rounded-lg text-[10px] font-black uppercase text-indigo-500 tracking-wider inline-flex items-center gap-1"
                        >
                          <Eye size={10} />
                          View Cert
                        </button>
